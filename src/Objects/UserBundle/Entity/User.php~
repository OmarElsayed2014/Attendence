...
class User implements AdvancedUserInterface {
    ...
    /**
     * @ORM\OneToOne(targetEntity="Objects\AttendenceBundle\Entity\Employee",mappedBy="user")
     *
     */
    private $employee;

    /**
     * @ORM\OneToMany(targetEntity="Objects\AttendenceBundle\Entity\Permission",mappedBy="user")
     */
    private $permissions;

    /**
     * @ORM\oneToMany(targetEntity="Objects\AttendenceBundle\Entity\UserVacation",mappedBy="user")
     */
    private $vacations;

    /**
     * @ORM\oneToMany(targetEntity="Objects\AttendenceBundle\Entity\Attendence",mappedBy="user")
     */
    private $attendences;
     ...
     * Set employee
     *
     * @param \Objects\AttendenceBundle\Entity\Employee $employee
     * @return User
     */
    public function setEmployee(\Objects\AttendenceBundle\Entity\Employee $employee = null)
    {
     ...
     * Get employee
     *
     * @return \Objects\UserBundle\Entity\Employee
     */
     ...
     * Add permissions
     *
     * @param \Objects\AttendenceBundle\Entity\Permission $permissions
     * @return User
     */
    public function addPermission(\Objects\AttendenceBundle\Entity\Permission $permissions)
    {
     ...
     * @param \Objects\AttendenceBundle\Entity\Permission $permissions
     */
    public function removePermission(\Objects\AttendenceBundle\Entity\Permission $permissions)
    {
     ...
     * Add vacations
     *
     * @param \Objects\AttendenceBundle\Entity\UserVacation $vacations
     * @return User
     */
    public function addVacation(\Objects\AttendenceBundle\Entity\UserVacation $vacations)
    {
     ...
     * @param \Objects\AttendenceBundle\Entity\UserVacation $vacations
     */
    public function removeVacation(\Objects\AttendenceBundle\Entity\UserVacation $vacations)
    {
     ...
     * Add attendences
     *
     * @param \Objects\AttendenceBundle\Entity\Attendence $attendences
     * @return User
     */
    public function addAttendence(\Objects\AttendenceBundle\Entity\Attendence $attendences)
    {
     ...
     * @param \Objects\AttendenceBundle\Entity\Attendence $attendences
     */
    public function removeAttendence(\Objects\AttendenceBundle\Entity\Attendence $attendences)
    {
